 ...
 * JVM properties:        REDIS_HOST, REDIS_PORT
 *                        (set via CATALINA_OPTS=-DREDIS_HOST=... for Tomcat deployments)
 */
public class RedisConfig {
  ...
  private static String resolve(String envKey, Properties props,
    ...
    String sysProp = System.getProperty(envKey);  // -DREDIS_HOST=... via CATALINA_OPTS
